...
public class AudioRecordView {
    ...
    private TextView timeText, textViewSlide , tvCancel;
    ...
    private LinearLayout lyInputContainer;
    ...
    public void initView(ViewGroup view) {
        ...
        lyInputContainer = view.findViewById(R.id.ly_input_container);
    ...
    public void showLoading() {
        editTextMessage.setHint("جارى الارسال ..");
    ...
    public void hideLoading() {
        ...
        editTextMessage.setHint("اكتب شيئا ..");
